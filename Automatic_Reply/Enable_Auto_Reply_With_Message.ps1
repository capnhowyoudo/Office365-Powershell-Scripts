...
Set-MailboxAutoReplyConfiguration -Identity "SharedMailboxName" -AutoReplyState Enabled -ExternalAudience All -InternalMessage "Your internal auto-reply message here." -ExternalMessage "Your external auto-reply message here."
